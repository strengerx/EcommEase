...
const About = () => {
    const metadata = {
        ...
        description:
            "Learn about our mission and values shaping your shopping journey.",
    };
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-slate-200 p-6 rounded-lg shadow-lg mb-6">
                    ...
                    <p className="text-slate-800">
                        At EcommEase, our mission is to provide a seamless and enjoyable
                        online shopping experience for our customers. We believe in quality,
                ...
                <div className="bg-slate-200 p-6 rounded-lg shadow-lg mb-6">
                    ...
                    <p className="text-slate-800">
                        EcommEase was founded with the vision of creating a user-friendly
                        platform that brings the best products from around the world right
                        to your doorstep. We started as a small team with big dreams and
                        have grown into a trusted name in the e-commerce industry.
                    </p>
                </div>
                ...
                <div className="bg-slate-200 p-6 rounded-lg shadow-lg mb-6">
                    ...
                    <ul className="list-disc list-inside text-slate-800">
                        ...
                        <li>
                            Quality Products: We curate only the best products for our
                            customers.
                        </li>
                        <li>
                            Innovation: We continuously strive to improve and innovate our
                            platform.
                        </li>
                        <li>
